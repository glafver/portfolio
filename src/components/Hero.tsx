...
const Hero: React.FC = () => {
    ...
    return (
        <>
            <div className="bg-neutral-200 p-12 py-20">
                <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between">
                    <div className="lg:w-1/2 lg:pr-10">
                        <h1 className="text-6xl font-bold mb-4 text-neutral-800">
                            Hey, I'm
                        ...
                        <p className="py-12 font-forum text-2x mb-6 text-justify">
                        ...
                        <div className='flex w-full justify-center lg:justify-start mb-12 lg:mb-0'>
                            <button
                                onClick={() => { handleOpen(); }}
