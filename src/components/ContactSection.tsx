        ...
        <div id='contact' className="bg-neutral-200 h-72 lg:h-96 lg:pb-36 mt-36 lg:mt-36 relative">
            ...
            >
                <div className='p-12 pt-6 lg:pt-20 text-center m-auto'>
                    <h1 className="text-3xl lg:text-6xl font-semibold mb-6 lg:mb-12 text-white">
                        Interested in working with me?
                    </h1>
                    <div className='flex flex-col-reverse lg:flex-row items-center justify-center'>
                        <button
                            onClick={() => { handleOpen(); }}
                            className="w-max uppercase bg-neutral-800 text-white font-bold py-2 px-4 mr-3 rounded-full hover:text-neutral-800 hover:bg-white">
                            Get in touch
                        </button>
                        <button
