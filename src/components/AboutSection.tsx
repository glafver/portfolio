...
const AboutSection: React.FC = () => {
    return (
        <div id='about' className="relative max-w-7xl mx-auto flex flex-col lg:flex-row items-center md:justify-between p-12 py-36 my-24">
            <div className="lg:w-1/3 mb-6 md:mb-0 z-10">
                <img
                    src={about_img}
                    alt="Profile"
                    className="rounded h-auto w-fll"
                />
            </div>
            <div className="lg:w-2/3 pl-36 z-10">
                <div className="text-right">
                    <h2 className="text-6xl font-bold text-gray-800 pb-16">About
